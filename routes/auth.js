...
router.post('/register', async(req,res) => {
    ...
    const building = await Building.findOne({ buildingCode: buildingCodeRequested });
    if (!building) {
    ...
    user=new User({ name, email, password: hashedPassword, role, buildingCodeRequested,building: building._id});
    await user.save();
